  ...
  return (
    <div className="hidden md:flex  mt-28 ">
      <div className="flex  w-2/3 flex-col gap-10">
        <p className="font-bold text-transparent w-2/3 text-4xl bg-clip-text bg-gradient-to-r from-[#AE67FA] to-[#F49867]">
          The Future is Now and You Just Need To Realize It. Step into Future
          Today & Make it Happen.
        </p>
        <span className="text-[#FF8A71] mt-6">
      ...
      <div className="flex w-2/3  flex-col  gap-10">
        <div className="flex justify-end gap-32">
          ...
          <p className="text-[#81AFDD] w-1/2 text-justify">
